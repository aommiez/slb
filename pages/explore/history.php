<div>
    <p>
        <img src="images/History/History275x774.png">
    </p>
    ...
    <h3>Thai Culture (Must know)</h3>
    <p>
        <ul>
        <li>Thai people hold their King and Queen and the Royal Family in great reverence, and will not tolerate foreigners showing disrespect to them.</li>
        <li>Generally Thai women are conservative so do not touch them without their consent.</li>
        <li>Dress properly when entering a Buddhist temple. Miniskirts and shorts are not allowed. Take your shoes off before going inside the hall of worship. Ladies must not on any account touch a Buddhist monk.</li>
        <li>Traditionally, Thais greet each other withWai (by pressing the palms together at the chest). If someone Wai you, you should Wai back.</li>
        <li>Thai people smile to express gladness and happiness, to thank for small services, to return the Wai of children and inferior persons, and even to excuse small inconveniences.</li>
        <li>Do not touch a person's head, nor ruffle his hair.  The head is the noblest part of the body. A sincere apology should be offered immediately if you touch someone's head unintentionally.</li>
        <li>Avoid placing your feet on the table while sitting. Never use your foot to point things out or to touch any part of the body of anyone. This is considered rude.</li>
     </ul>

    </p>


    <p><img src="images/History/Image207x775.png"></p>
</div>
